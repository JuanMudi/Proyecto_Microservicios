...
@Component({
  selector: 'app-service-info-supplier',
  templateUrl: './service-info-supplier.component.html',
  styleUrl: './service-info-supplier.component.css'
})
export class ServiceInfoSupplierComponent implements OnInit {
  ...
  viewWeather() {
    this.router.navigate(['climb-information']);
  }
