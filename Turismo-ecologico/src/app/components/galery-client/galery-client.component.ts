...
@Component({
  selector: 'app-galery-client',
  templateUrl: './galery-client.component.html',
  styleUrl: './galery-client.component.css'
})
export class GaleryClientComponent {
    searchQuery: string = '';
    ...
    goToDetail(id: number) {
      this.router.navigate(['/service-info', id]); // Navegar al componente de detalle con el ID del servicio
    }
