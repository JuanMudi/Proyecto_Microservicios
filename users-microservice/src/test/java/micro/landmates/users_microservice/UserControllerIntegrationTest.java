...
public class UserControllerIntegrationTest {
    ...
    public void testGetAllUsers_Success() {
        List<UserSummaryDTO> userSummaries = List.of(
                new UserSummaryDTO("12345", "User One", "user1@example.com", "webpage.com", List.of("facebook")),
                new UserSummaryDTO("67890", "User Two", "user2@example.com", "webpage.com", List.of("facebook")));
    ...
    public void testGetUserById_Success() {
        UserSummaryDTO userSummary = new UserSummaryDTO("12345", "User One", "user1@example.com", "webpage.com", List.of("instagram"));
